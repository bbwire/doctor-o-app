      ...
      >
        <div class="w-full max-w-2xl rounded-2xl bg-gray-900/95 flex flex-col items-center py-12 px-8 sm:py-16 sm:px-12 border border-gray-800 shadow-xl">
          ...
          <UAlert
            ...
            description="Please be in a quiet place with minimal background noise so you and your doctor can hear each other clearly."
            class="mb-4 w-full max-w-sm text-left"
          />
          <UAlert
            v-if="jitsiErrorText"
            color="red"
          ...
          <UButton
            ...
            @click="joinJitsi"
          >
            Join {{ consultation?.consultation_type === 'video' ? 'video' : 'audio' }} call
          </UButton>
        </div>
      </div>
        ...
        <div class="flex-1 min-h-0 relative">
          ...
          >
            <div class="text-center">
              ...
              <p class="text-gray-400">Joining call...</p>
            </div>
          </div>
          <div
...
function getPatientDisplayName () {
  return user.value?.name || 'Patient'
}
